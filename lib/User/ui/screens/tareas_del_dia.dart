...
import 'package:app/widgets/calendar_widget_schudle.dart';
import 'package:flutter/material.dart';

class Tareas_Del_dia extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        body:
            CalendarWidgetSchedule(), //*Se manda llamar la funcion que creamos en el archivo de calendar_widget.dart
